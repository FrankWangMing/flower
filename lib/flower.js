    ...
    var If = function M(L) {
      ...
      function Rt(t, r, i, c, h, o, d, _) {
        ...
        if (!y && typeof t != "function")
          throw new rt(l);
        var I = c ? c.length : 0;
        if (I || (r &= -97, c = h = e), d = d === e ? d : Cn(k(d), 0), _ = _ === e ? _ : k(_), I -= h ? h.length : 0, r & U) {
          var z = c, b = h;
          c = h = e;
        }
        var P = y ? e : Wi(t), N = [
        ...
        if (P && mh(N, P), t = N[0], r = N[1], i = N[2], c = N[3], h = N[4], _ = N[9] = N[9] === e ? y ? 0 : t.length : Cn(N[9] - I, 0), !_ && r & (W | F) && (r &= -25), !r || r == R)
          var Y = eh(t, r, i);
...
class sp extends ls {
  constructor() {
    ...
    const e = Ur.gl, s = 45 * Math.PI / 180, a = e.canvas.width / e.canvas.height, f = 0.1, l = 100, p = In.create();
