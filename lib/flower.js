  ...
  (function() {
    ...
    var tl = function a(g) {
      ...
      function Vt(n, t, e, r) {
        ...
        if (!l)
          return c;
        e && (t = G(t, cn(e))), r ? (f = Rr, o = !1) : t.length >= q && (f = $t, o = !1, t = new at(t));
        n:
          for (; ++i < l; ) {
      ...
      function ha(n, t, e, r, i, f, o) {
        ...
        if (d) {
          ...
          p = c, v || x || S ? R(l) ? p = l : $(l) ? p = fn(l) : x ? (d = !1, p = tf(c, !0)) : S ? (d = !1, p = ef(c, !0)) : p = [] : ie(c) || pt(c) ? (p = l, pt(l) ? p = jf(l) : (!H(l) || zn(l)) && (p = Sf(c))) : d = !1;
        }
      ...
      function ne(n, t, e, r) {
        ...
        for (var i = -1, f = t.length, o = f - 1, l = n; l != null && ++i < f; ) {
          ...
          if (i != o) {
            var p = l[c];
            _ = r ? r(p, c, l) : s, _ === s && (_ = H(p) ? p : $n(t[i + 1]) ? [] : {});
          }
          Qt(l, c, _), l = l[c];
        }
        return n;
      ...
      function vf(n, t, e, r, i, f) {
        return H(n) && H(t) && (f.set(t, n), Ue(n, t, s, vf, f), f.delete(t)), n;
      }
      function Wa(n) {
        return ie(n) ? s : n;
      }
...
`);
      ...
      function zf(n, t, e) {
        ...
        if (typeof n != "function")
          throw new xn(X);
        t = Rn(t) || 0, H(e) && (p = !!e.leading, d = "maxWait" in e, f = d ? Y(Rn(e.maxWait) || 0, t) : f, v = "trailing" in e ? !!e.trailing : v);
        function x(z) {
          var On = r, Yn = i;
      ...
      function $g(n, t, e) {
        ...
        if (t = A(t, 4), e == null) {
          ...
          i ? e = r ? new f() : [] : H(n) ? e = zn(f) ? Ot(Ie(n)) : {} : e = {};
        }
...
`) + d + `return __p
      ...
      function Ei(n, t, e) {
        var r = J(t), i = Me(t, r);
        e == null && !(H(t) && (i.length || !r.length)) && (e = t, t = n, n = this, i = Me(t, J(t)));
        var f = !(H(e) && "chain" in e) || !!e.chain, o = zn(n);
...
class gp {
  constructor(b) {
    Q(this, "canvas");
    Q(this, "gl");
    const s = window.devicePixelRatio || 1, D = hp(b), q = D.getBoundingClientRect();
    D.width = q.width * s, D.height = q.height * s, this.canvas = D, this.gl = D.getContext("webgl2", {
      stencil: !1
    });
...
const rr = class rr extends Li {
  constructor(s, D) {
    ...
    this.gl = s;
    for (let q of D)
      q.tie(s), q instanceof vp && (this.VertexShader = q), q instanceof dp && (this.FragmentShader = q);
  }
  create(s) {
  ...
  tie(s) {
    ...
    for (let q = 0; q < D; q++) {
      const X = s.getActiveAttrib(this.id, q).name;
      console.log("name", X);
...
class xp extends Array {
  ...
  createQueue(s) {
    ...
    D.push(
      ...
      D.push(
        new Ti(s, q.material.shader)
      ), q.material.state.forEach((tn) => {
        D.push(tn);
      }), q.material.uniform.forEach((tn) => {
        D.push(tn);
      }), q.geometry.vbos.forEach(
        (tn) => {
          D.push(tn);
        }
      ), q.geometry.drawers.forEach(
        (tn) => {
          D.push(tn);
        }
      );
